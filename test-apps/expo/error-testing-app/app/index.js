...
import {
  ...
  crashApp,
} from "../modules/native-exception-trigger";
// uncomment the line below to cause bundling error
// import foo from "bar";
const obj = { a: 7678 };
...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      />
      <Button
        title="Throw native module exception"
        onPress={() => {
          throwNativeException();
        }}
      />
      <Button
        title="Native crash app"
        onPress={() => {
          try {
            crashApp();
          } catch (e) {
            console.log("Could not crash app", e);
          }
        }}
      />
      <UglyButton />
