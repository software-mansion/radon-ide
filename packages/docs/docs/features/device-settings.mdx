...
9. **Rotate Device** - allows to change orientation of the device.

Currently supported orientations are: *Portrait*, *Landscape Left* and *Landscape Right*.

<img width="250" src="/img/docs/ide_device_rotation.png" className="shadow-image" />

10. **Deep links** - allows opening deep links and website URLs on the device. Website URLs will open in the default device browser.

<img width="450" src="/img/docs/ide_deep_link.png" className="shadow-image" />

11. **Enable replays** - enables or disables the "replay" functionality. After switching the `Enable Replays` toggle a `Replay` button appears in the Radon IDE panel.

<img width="300" src="/img/docs/ide_replays_enabled.png" className="shadow-image" />

12. **Show touches** - whether the touches should be visible on the device preview.

13. **Show Device Frame** - allows to hide the frame of the device in the preview.
