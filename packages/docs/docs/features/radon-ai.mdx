...
<CollapsibleSection title="Claude Code">
...
<CollapsibleSection title="OpenClaw">

Install the [FOOBAR](https://clawhub.com/skills/FOOBAR) skill using the [ClawHub](https://clawhub.com) CLI:

```bash
npm i -g clawhub
clawhub install FOOBAR
```

Start a new OpenClaw session — the skill is now available.

</CollapsibleSection>

<CollapsibleSection title="Codex">
...
<CollapsibleSection title="OpenCode">
...
<CollapsibleSection title="Gemini CLI">
...
<CollapsibleSection title="Goose">
...
<CollapsibleSection title="Kiro CLI">
