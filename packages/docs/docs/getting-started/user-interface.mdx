...
13. **Launch configuration selector** - lets you switch between different [launch configurations](/docs/guides/configuration) for your workspace.
    ...
    In a monorepo project, the drop-down also displays all automatically detected React Native applications
    in the workspace, allowing easily selecting and switching between them.
