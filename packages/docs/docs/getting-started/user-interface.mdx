...
13. **Launch configuration selector** - lets you switch between different [launch configurations](/docs/guides/configuration) for your workspace.
    ...
    In a monorepo workspace, the drop-down displays all automatically detected React Native applications.
    If you configure any custom launch configurations, you will be able to select or edit them from this
    drop-down as well.
