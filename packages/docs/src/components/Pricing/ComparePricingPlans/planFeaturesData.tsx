...
export const planFeaturesData = [
  ...
  { label: "Maestro testing integration",             free: false, pro: true, team: true, enterprise: true },
  ...
  { label: "Single Sign-On (SAML 2.0)",               free: false, pro: false, team: false, enterprise: true },
