...
function transformWrapper({ filename, src, ...rest }) {
  ...
  if (isTransforming("node_modules/react-native/Libraries/Core/InitializeCore.js")) {
    ...
    // which is why the src needs to come before it.

    console.log("frytki transform react-query", filename);
    src = `${src};require("__RNIDE_lib__/plugins/react-query-devtools.js");`;
