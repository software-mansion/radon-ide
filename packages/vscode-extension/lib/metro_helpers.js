    ...
    if (originalResolveRequest) {
      ...
      config = {
        ...
        resolver: {
          ...
          blockList: [
            /\.d\.tsx?$/, // type definition files are often generated by plugins, they never impact the bundle though, so it is safe to ignore changes to them from triggering hot reload
