...
type ExportLogsViewProps = {
	// In the future we can accept dynamic log names here
	// logs?: string[]
};

function ExportLogsView(_props: ExportLogsViewProps) {
	...
	return (
		<form className="container" data-testid="export-logs-view" onSubmit={(e) => e.preventDefault()}>
			<p className="export-logs-intro">
				Select which logs to include in the export. You can uncheck items you don't need.
			</p>
