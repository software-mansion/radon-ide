...
export const ANDROID_HOME = process.env.ANDROID_HOME || (process.platform === "win32")
  ? path.join(os.homedir(), "AppData/Local/Android/Sdk")
  : path.join(os.homedir(), "Library/Android/sdk");

const ANDROID_STUDIO_PATH = (process.platform === "win32")
