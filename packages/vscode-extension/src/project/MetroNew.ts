...
export async function launchMetro({
  resetCache,
  dependencies,
  launchConfiguration,
  devtoolsPort,
...
class SubprocessMetroSession implements MetroSession, Disposable {
  ...
  private usesNewDebugger: boolean = true;
  ...
  private handleMetroEvent = (event: MetroEvent) => {
