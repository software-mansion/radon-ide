...
import { SELECTED_LAUNCH_CONFIGURATION_KEY } from "./project";
...
async function shouldUseExpoCLI() {
  ...
  const config = extensionContext.workspaceState.get<LaunchConfigurationOptions>(
