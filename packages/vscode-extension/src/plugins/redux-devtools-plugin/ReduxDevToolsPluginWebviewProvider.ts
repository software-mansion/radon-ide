...
// const nonce = getNonce();
   ...
   <html lang="en">
      ...
      <body>
        ...
        <div id="root"></div>
      <script src="./redux/js/web/AppEntry-98f8b8fb7deeb694e1734d66e47fb35a.js" defer></script>
    </body>
    </html>
  `;
}

// this.postMessage()webviewView.webview.postMessage({ command: "redux_log", data: { type: 'ACTION', payload: {payload: 0}, action: {type:'ACTION_TYPE', param1: 'param1', param2: 'param2', payload: 'payload'},state: {state: 0}}});
...
export class ReduxDevToolsPluginWebviewProvider implements WebviewViewProvider {
  ...
  public resolveWebviewView(
    ...
    this.webviewView.webview.html = generateWebviewContent(
      extensionContext,
      webviewView.webview,
